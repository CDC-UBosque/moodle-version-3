...
<div class="well">
<h2>uebtheme</h2>
<p><img class=img-polaroid src="uebtheme/pix/screenshot.jpg" /></p>
</div>
<div class="well">
<h3>Parents</h3>
...
<h3>Modifications</h3>
<p>Centro de Diseño<br>
Universidad El Bosque</p>
</div></div>';
...
$string['banneruebimage1'] = 'Upload your image for banner ';
$string['tbanneruebimage1desc'] = 'Upload your image for banner';
$string['bannerueburl1'] = 'Enter banner URL';
$string['tbannerueburl1desc'] = 'Enter the text for banner block';
$string['bannerueburl1default'] = 'Default text for banner block';
$string['banner1'] = 'Image for banner';
$string['banner1desc'] = 'Enter the text for banner block';
$string['banner1default'] = 'Default text for banner block';

$string['banneruebimage2'] = 'Upload your image for banner ';
$string['tbanneruebimage2desc'] = 'Upload your image for banner';
$string['bannerueburl2'] = 'Enter banner URL';
$string['tbannerueburl2desc'] = 'Enter the text for banner block';
$string['bannerueburl2default'] = 'Default text for banner block';
$string['banner2'] = 'Image for banner';
$string['banner2desc'] = 'Enter the text for banner block';
$string['banner2default'] = 'Default text for banner block';
...
$string['bannerimage'] = 'Upload image';
$string['fbannerimagedesc'] = 'Upload image for the first block.';
$string['bannername'] = 'Enter block name';
$string['fbannernamedesc'] = 'Enter the name of first block in about site section.';
$string['bannertext'] = 'Enter block sub text';
$string['fbannertextdesc'] = 'Enter the sub text for the first block.';
$string['bannerurl'] = 'Enter url';
$string['fbannerurldesc'] = 'Enter the target url for the first block.';
