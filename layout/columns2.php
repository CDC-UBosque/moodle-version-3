...
$regionmain = 'col-md-10 col-lg-10 pull-right desktop-first-column '; /* changes classname two-column-main */
$sidepre = 'col-md-2 col-lg-2 pull-left desktop-first-column '; /* changes classname two-column-sidebar */
// Reset layout mark-up for RTL languages.
if (right_to_left()) {
    $regionmain = 'col-md-10 col-lg-10 pull-right desktop-first-column '; /* changes classname */
    $sidepre = 'col-md-2 col-lg-2 pull-left desktop-first-column '; /* changes classname */
}
...
<div id="page">
    ...
    <div id="page-content" class="background-grey row">
    	<div class="container">
