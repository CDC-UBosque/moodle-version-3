...
if (!empty($checkaboutsiteimage1)) {
    ...
    $aboutsiteimage1 = $CFG->wwwroot."/theme/uebtheme/data/icon-conts-1.png";
}
...
if (!empty($checkaboutsiteimage2)) {
    ...
    $aboutsiteimage2 = $CFG->wwwroot."/theme/uebtheme/data/icon-conts-2.png";
}
...
if (!empty($checkaboutsiteimage3)) {
    ...
    $aboutsiteimage3 = $CFG->wwwroot."/theme/uebtheme/data/icon-conts-3.png";
}
...
if (!empty($checkaboutsiteimage4)) {
    ...
    $aboutsiteimage4 = $CFG->wwwroot."/theme/uebtheme/data/icon-conts-4.png";
}
?>
<?php
...
<div class="about">
<div class="container">
<h3 class="header-b-2"><?php echo format_text($html->aboutsitesubheading, "", $uebthemeformatoptions);?></h3>
<h1 class="h-large"><?php echo format_text($html->aboutsiteheading, "", $uebthemeformatoptions);?><span></span></h1>
...
<h5><a href="<?php echo $html->aboutsiteurl1; ?>"><?php echo format_text($html->aboutsitename1, "", $uebthemeformatoptions); ?></a></h5>
<?php echo format_text($html->aboutsitetext1, "", $uebthemeformatoptions); ?>
...
<h5><a href="<?php echo $html->aboutsiteurl2; ?>"><?php echo format_text($html->aboutsitename2, "", $uebthemeformatoptions); ?></a></h5>
<?php echo format_text($html->aboutsitetext2, "", $uebthemeformatoptions); ?>
</div><!-- END of .about-item -->
<?php
    }
...
<h5><a href="<?php echo $html->aboutsiteurl3; ?>"><?php echo format_text($html->aboutsitename3, "", $uebthemeformatoptions); ?></a></h5>
<?php echo format_text($html->aboutsitetext3, "", $uebthemeformatoptions); ?>
</div><!-- END of .about-item -->
<?php
    }
...
<h5><a href="<?php echo $html->aboutsiteurl4; ?>"><?php echo format_text($html->aboutsitename4, "", $uebthemeformatoptions); ?></a></h5>
<?php echo format_text($html->aboutsitetext4, "", $uebthemeformatoptions); ?>
</div><!-- END of .about-item -->
<?php 
    }
?>
