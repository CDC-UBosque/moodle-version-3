...
if (!empty($checkslideimage1)) {
    ...
    $sliderimage1 = $CFG->wwwroot."/theme/uebtheme/data/sl-1.jpg";
}
...
if (!empty($checkslideimage2)) {
    ...
    $sliderimage2 = $CFG->wwwroot."/theme/uebtheme/data/sl-1.jpg";
}
...
if (!empty($checkslideimage3)) {
    ...
    $sliderimage3 = $CFG->wwwroot."/theme/uebtheme/data/sl-1.jpg";
}
...
if (!empty($checkslideimage4)) {
    ...
    $sliderimage4 = $CFG->wwwroot."/theme/uebtheme/data/sl-1.jpg";
}
...
if (!empty($checkslideimage5)) {
    ...
    $sliderimage5 = $CFG->wwwroot."/theme/uebtheme/data/sl-1.jpg";
}
...
if (!empty($checkslideimage6)) {
    ...
    $sliderimage6 = $CFG->wwwroot."/theme/uebtheme/data/sl-1.jpg";
}
?>
...
?>
	<li class="content-wrap">
		...
		<div class="top-slide-content"><div class="customslider">
			<?php echo format_text($html->slidertext1, "", $uebthemeformatoptions);?>
<?php
        if (!empty($html->sliderbuttontext1)) {
?>
			<a href="<?php echo $html->sliderurl1;?>" class="btn-1"><?php echo format_text($html->sliderbuttontext1, "", $uebthemeformatoptions);?></a>
<?php
        }
?>
		</div></div>
...
?>
	<li class="content-wrap">
		...
		<div class="top-slide-content"><div class="customslider">
			<?php echo format_text($html->slidertext2, "", $uebthemeformatoptions);?>
<?php
        if (!empty($html->sliderbuttontext2)) {
?>
			<a href="<?php echo $html->sliderurl2;?>" class="btn-1"><?php echo format_text($html->sliderbuttontext2, "", $uebthemeformatoptions);?></a>
<?php
        }
?>
		</div></div>
...
?>
	<li class="content-wrap">
		...
		<div class="top-slide-content">
			<?php echo format_text($html->slidertext3, "", $uebthemeformatoptions);?>
<?php
        if (!empty($html->sliderbuttontext3)) {
?>
			<a href="<?php echo $html->sliderurl3;?>" class="btn-1"><?php echo format_text($html->sliderbuttontext3, "", $uebthemeformatoptions);?></a>
<?php
        }
?>
		</div>
...
?>
	<li class="content-wra    ">
		...
		<div class="top-slide-content">
			<?php echo format_text($html->slidertext4, "", $uebthemeformatoptions);?>
<?php
        if (!empty($html->sliderbuttontext4)) {
?>
			<a href="<?php echo $html->sliderurl4;?>" class="btn-1"><?php echo format_text($html->sliderbuttontext4, "", $uebthemeformatoptions);?></a>
<?php
        }
?>
		</div>
...
?>
	<li class="content-wrap">
		...
		<div class="top-slide-content">
			<?php echo format_text($html->slidertext5, "", $uebthemeformatoptions);?>
<?php
        if (!empty($html->sliderbuttontext5)) {
?>
			<a href="<?php echo $html->sliderurl6;?>" class="btn-1"><?php echo format_text($html->sliderbuttontext5, "", $uebthemeformatoptions);?></a>
<?php
        }
?>
        </div>
...
?>
	<li class="content-wrap">
		...
		<div class="top-slide-content">
			<?php echo format_text($html->slidertext6, "", $uebthemeformatoptions);?>
<?php
        if (!empty($html->sliderbuttontext6)) {
?>
			<a href="<?php echo $html->sliderurl6;?>" class="btn-1"><?php echo format_text($html->sliderbuttontext6, "", $uebthemeformatoptions);?></a>
<?php
        }
?>
		</div>
